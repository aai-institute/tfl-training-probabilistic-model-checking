...
ROOT_DIR="${HOME}"/tfl-training-probabilistic-model-checking
...
pip install -e "."; echo "Installed tfl-training-probabilistic-model-checking" ; python scripts/download_data.py
