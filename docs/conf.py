# -*- coding: utf-8 -*-
#
# tfl-training-probabilistic-model-checking documentation build configuration file
#
...
def linkcode_resolve(domain, info):
    link_prefix = "https://github.com/appliedAI-Initiative/tfl-training-probabilistic-model-checking/blob/master"
    if domain != "py":
        return None
    if not info["module"]:
        return None
...
project = "tfl-training-probabilistic-model-checking"
...
htmlhelp_basename = "tfl-training-probabilistic-model-checking_doc"
...
man_pages = [
    ("index", "tfl-training-probabilistic-model-checking", "", ["appliedAI TransferLab"], 1)
]
